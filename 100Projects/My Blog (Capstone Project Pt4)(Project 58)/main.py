...
class PostForm(FlaskForm):
    ...
    subtitle = StringField(label="The subtitle", validators=[DataRequired()])
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", is_editing=True, form=edit_form)
